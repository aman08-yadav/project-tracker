...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if ((user === null || user === void 0 ? void 0 : user.role) !== 'faculty' && createProjectBtn) {
    ...
    if (createProjectForm) {
        createProjectForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                createProjectModal === null || createProjectModal === void 0 ? void 0 : createProjectModal.classList.remove('active');
                loadProjects();
            }
            catch (err) {
                alert(err.message);
