...
async function loadAnalytics() {
    try {
        const res = await ApiClient.get(`/analytics/project/${projectId}`);
        ...
        <div class="stat-box">
          <h4>Total Members</h4>
          <p>${(project === null || project === void 0 ? void 0 : project.memberCount) || memberStats.length}</p>
        </div>
        <div class="stat-box">
          <h4>Total Uploads</h4>
          <p>${(project === null || project === void 0 ? void 0 : project.totalUploads) || 0}</p>
        </div>
        <div class="stat-box">
          <h4>Completed Tasks</h4>
          <p>${(project === null || project === void 0 ? void 0 : project.completedTasks) || 0} / ${(project === null || project === void 0 ? void 0 : project.totalTasks) || 0}</p>
        </div>
      `;
        }
        ...
        if (tableBody) {
            tableBody.innerHTML = memberStats.map((stat) => `
        <tr>
...
function drawChart(canvasId, data, dataKey, title, color) {
